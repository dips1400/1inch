...
import { Container, Box, Stack, Grid, useTheme, Typography, useMediaQuery} from '@mui/material'
...
const Section5 = () => {
  ...
  return (
    <Container sx={{mt : {xs : 10, md: 20, lg: 25}}}>
        ...
        >
        <Grid container flexWrap="wrap-reverse" sx={{px:{
            xs:5, md:8
        }}}>
            <Grid item xs={12} md={5} lg={4}>
                ...
                sx={{height:"100%"}}>
                    ...
                    <OutlinedButton 
                    arrow fit={!isMobile}
                    fullWidth={isMobile} sx={{height : 48}}>Learn more
                    </OutlinedButton>
                </Stack>
            </Grid>
